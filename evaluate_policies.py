...
def run_generalization_analysis(
    ...
    truck_counts = [1, 2, 5, 10]
    delivery_counts = [1, 2, 3, 4]
    seeds_per_config = 50
...
def main():
    ...
    if args.generalization:
        ...
        print("Trucks: [1, 2, 5, 10], Deliveries: [1, 2, 3, 4], Seeds: 10 per config")
        print(f"Total evaluations: {4*4*10*3} = 480 episodes")
        print("="*80 + "\n")
