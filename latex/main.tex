...
\centering
\small
\caption{Performance comparison for the joint fleet eVRP setting over 500 held-out evaluation scenarios, in which assignment, sequencing, charging, and depot return are all decided online. GraphPPO reports the mean over three independent training seeds with the seed range in brackets; all other learning-based rows are single seeds trained at a smaller interaction budget. Travel, charging, service, and total times are fleet totals averaged over all episodes, so a method that declines instances is not flattered by conditioning.}
\begin{tabular}{@{}lcccccc@{}}
\toprule
Metric & CP-SAT & ALNS & Heuristic & PPO & MaskPPO & GraphPPO (Ours) \\
\midrule
Success rate (\%) & $62.2$ & $61.4$ & $55.2$ & $50.6$ & $67.0$ & $\mathbf{84.3}$ $[83.0, 85.8]$ \\
Wilson 95\% CI & $[57.9, 66.3]$ & $[57.1, 65.6]$ & $[50.8, 59.5]$ & $[46.2, 55.0]$ & $[62.8, 71.0]$ & $[79.5, 88.6]$ \\
Completed fraction (-) & $0.932$ & $0.930$ & $0.917$ & $0.968$ & $0.980$ & $\mathbf{0.991}$ \\
Avg.\ truck SoC at finish (\%) & $56$ & $57$ & $62$ & $46$ & $44$ & $49$ \\
Total charging sessions (-) & $34.6$ & $35.4$ & $44.4$ & $18.9$ & $16.1$ & $\mathbf{13.4}$ \\
\midrule
Total charging time (H) & $15.6$ & $15.7$ & $19.4$ & $11.2$ & $12.5$ & $\mathbf{9.4}$ \\
Total routing time (H) & $167.5$ & $168.6$ & $199.8$ & $143.1$ & $152.3$ & $\mathbf{123.5}$ $[120.9, 125.3]$ \\
Unloading time (H) & $1.9$ & $1.9$ & $1.9$ & $2.0$ & $2.0$ & $2.0$ \\
Total time (H) & $184.9$ & $186.3$ & $221.1$ & $156.3$ & $166.8$ & $\mathbf{134.8}$ \\
\midrule
Exec.\ time (ms/decision) & $2.4$ & $2.0$ & $\mathbf{0.8}$ & $1.9$ & $3.9$ & $5.6$ \\
\bottomrule
\end{tabular}
